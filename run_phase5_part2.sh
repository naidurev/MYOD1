...
echo "========================================"
echo "Phase 5 Part 2: Domain Visualization"
echo "========================================"
echo ""
...
pip install matplotlib seaborn pandas biopython logomaker --break-system-packages

echo ""

# Create visualization script
cat > visualize_domains.py << 'PYSCRIPT'
#!/usr/bin/env python3

"""
Phase 5 Part 2: Domain Architecture and Conservation Visualization
"""
...
print("="*70)
print("Domain Visualization - Phase 5 Part 2")
print("="*70)
print("")
...
def create_conservation_heatmap(conservation_file, alignment_file, output_file, title):
    ...
    sns.heatmap(matrix, cmap='RdYlGn', vmin=0, vmax=1, cbar_kws={'label': 'Conservation Score'},
                ax=ax2, xticklabels=50, yticklabels=[alignment[i].id[:20] for i in range(n_display)])
    ax2.set_xlabel('Position', fontsize=11, fontweight='bold')
    ax2.set_ylabel('Sequences (top 20)', fontsize=11, fontweight='bold')
...
print("  2. Conservation heatmaps (2)")
...
echo "========================================"
echo ""
echo "Created beautiful visualizations showing:"
echo "  ✓ Domain architecture of MRF family"
echo "  ✓ Conservation heatmaps"
echo "  ✓ Sequence logos (motifs)"
echo "  ✓ Orthogroup comparison"
echo "  ✓ Functional site predictions"
echo ""
echo "All figures are publication-ready (300 DPI)"
echo ""
echo "Next: Create final comprehensive report!"
echo ""
